	...
	<body>
		<main>
			...
			<div class="container" style="width: 90%;margin-bottom: 100">
				<div class="row">
					<div class="col s12 blu"><h5>TITOLO<i class="material-icons prefix left golden med-icon">assignment</i></i></h5></div>
				</div>
			...
			<div class="container" style="width: 90%;margin-bottom: 100">
				...
				<a href="index.php" class="waves-effect waves-light btn right button"><i class="material-icons left">build</i>Admin Page</a>
			</div>
	<?php } ?>
		</main>
